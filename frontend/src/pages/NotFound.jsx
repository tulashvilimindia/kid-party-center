      ...
      <div className="not-found-container">
        <div className="not-found-content">
          ...
          <div className="not-found-actions">
            <Link to={`/${currentLang}`} className="btn btn-primary btn-lg">
              Back to Home
            </Link>
          ...
          <div className="quick-links-grid">
            <Link to={`/${currentLang}/contact`} className="quick-link-card">
              <span className="quick-link-icon">📞</span>
              <span className="quick-link-text">Contact Us</span>
            </Link>
            <Link to={`/${currentLang}/calendar`} className="quick-link-card">
              <span className="quick-link-icon">📅</span>
              <span className="quick-link-text">Check Availability</span>
            </Link>
            <Link to={`/${currentLang}/faq`} className="quick-link-card">
              <span className="quick-link-icon">❓</span>
              <span className="quick-link-text">FAQ</span>
            </Link>
            <Link to={`/${currentLang}/about`} className="quick-link-card">
